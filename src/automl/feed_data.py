...
class BalancedDataset(Dataset):
    def __init__(self, dataframe, images_path, metadata, resized_res=None):
        """
        ...
        # Read original image resolution from metadata (e.g., (512, 512))
        #but if  we do a resizing then use that one. 
        ...
        # Define transforms
        self.default_transform = get_default_transforms(self.metadata, resized_res)  # e.g., Resize + Normalize

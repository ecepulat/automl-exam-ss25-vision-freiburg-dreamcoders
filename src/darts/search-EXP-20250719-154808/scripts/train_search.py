...
args = SimpleNamespace(
    data=r'C:\\Users\\PC\Desktop\\autoML\\Project\\data\\fashion',
    batch_size=32,
    learning_rate=0.025,
...
def main():
  ...
  model = Network(args.init_channels, FASHION_CLASSES, args.layers, criterion)
  model = model.cuda()
  ...
  train_data = FashionDataset(root=r'C:\\Users\\PC\Desktop\\autoML\\Project\\data', split='train', transform=train_transform)
